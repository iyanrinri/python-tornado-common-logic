"""
API handlers for median calculation endpoints.
...
from ..services import median_service, MedianRequest, MedianResponse
...
class MedianHandler(BaseHandler):
        ...
        try:
            ...
            try:
                ...
                response_dict = {
                    ...
                    "array1_size": response.array1_size,
                    "array2_size": response.array2_size,
    ...
    def _format_validation_errors(self, errors: list) -> Dict[str, Any]:
        ...
        for error in errors:
            ...
            if "input" in error:
                formatted_error["invalid_value"] = error["input"]
